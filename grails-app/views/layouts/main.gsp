...
<div style="float: left; width: 20%; padding: 1em; height: 60%">
    <ul id="menu">
        ...
        <li>
            <a href="#">Load Balancing Intent</a>
            <ul>
                <li><a class="home" href="${createLink(uri: '/loadBalancingIntent/index')}">List</a></li>
                <li><a class="home" href="${createLink(uri: '/loadBalancingIntent/create')}">Create New</a></li>
            </ul>
        </li>
    </ul>
</div>
